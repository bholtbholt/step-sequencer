...
var _bholtbholt$step_sequencer$Types$Model = F5(
	function (a, b, c, d, e) {
		return {tracks: a, playback: b, playbackPosition: c, playbackSequence: d, bpm: e};
	});
var _bholtbholt$step_sequencer$Types$Track = F3(
	function (a, b, c) {
		return {sequence: a, name: b, clip: c};
	});
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('track-title'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _bholtbholt$step_sequencer$Views_PlaybackControls$renderPlaybackControls = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('playback-controls'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _bholtbholt$step_sequencer$Views_PlaybackControls$renderPlaybackButton(model),
			_1: {
				ctor: '::',
				_0: _bholtbholt$step_sequencer$Views_PlaybackControls$renderBPM(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _bholtbholt$step_sequencer$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('step-sequencer'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _bholtbholt$step_sequencer$Main$initHat = {sequence: _bholtbholt$step_sequencer$Main$initSequence, name: 'Hat', clip: 'hat'};
var _bholtbholt$step_sequencer$Main$initSnare = {sequence: _bholtbholt$step_sequencer$Main$initSequence, name: 'Snare', clip: 'snare'};
var _bholtbholt$step_sequencer$Main$initKick = {sequence: _bholtbholt$step_sequencer$Main$initSequence, name: 'Kick', clip: 'kick'};
var _bholtbholt$step_sequencer$Main$init = {
	...
	_0: {
		...
		tracks: _elm_lang$core$Array$fromList(
			{
				ctor: '::',
				_0: _bholtbholt$step_sequencer$Main$initHat,
				_1: {
					ctor: '::',
					_0: _bholtbholt$step_sequencer$Main$initSnare,
					_1: {
						ctor: '::',
						_0: _bholtbholt$step_sequencer$Main$initKick,
						_1: {ctor: '[]'}
					}
				}
			})
